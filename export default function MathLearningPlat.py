export default function MathLearningPlatform() {
  ...
  const score = tests.reduce((acc, test, idx) => {
      ...
      <header className="bg-white border-b border-slate-200 sticky top-0 z-10">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-slate-500">Самообучение математике в стиле Stepik</p>
          </div>

          <nav className="flex gap-6 text-sm font-medium">
            <a href="#modules" className="hover:text-blue-600 transition">Модули</a>
            <a href="#theory" className="hover:text-blue-600 transition">Теория</a>
            <a href="#practice" className="hover:text-blue-600 transition">Практика</a>
          </nav>
        </div>
      </header>
            ...
            >
              ...
              <div className="space-y-3">
                {test.options.map((option, optionIndex) => {
                  ...
                  const correct = optionIndex === test.correct;
